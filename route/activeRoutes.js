...
Activerouter
.get("/activities/search",tryCatchMiddleware(searchActivities))
.post(
  "/activities",
  verifyAdmintoken,
  multipleImageUpload,
  ...
  .get("/activities/:id", VerifyUserToken,tryCatchMiddleware(getSingleActivity))
  .put(
    "/activities/:id",
    verifyAdmintoken,
    multipleImageUpload,
  ...
  .delete("/activities/:id",verifyAdmintoken, tryCatchMiddleware(deleteActivity));
